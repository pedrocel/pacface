                ...
                <form class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" 
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="status-radio active">
                                    <input type="radio" name="status" value="active" class="peer" checked onchange="updateStatusStyle(this)">
                                ...
                                <label class="status-radio inactive">
                                    <input type="radio" name="status" value="inactive" class="peer" onchange="updateStatusStyle(this)">
                                    <div class="radio-content flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" 
                                       placeholder="Ex: 30">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <label class="shift-card rounded-lg cursor-pointer">
                                    <input type="radio" name="shift" value="morning" class="hidden">
                                ...
                                <label class="shift-card rounded-lg cursor-pointer">
                                    <input type="radio" name="shift" value="night" class="hidden">
                                    <div class="shift-content p-3 rounded-lg border-2 flex flex-col items-center gap-2">
