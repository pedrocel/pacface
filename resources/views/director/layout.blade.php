    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            <a href="{{ route('director.dashboard') }}" 
               ...
               {{ request()->routeIs('director.dashboard') ? 'text-gray-100 bg-gradient-to-br from-emerald-900 to-green-700 shadow-lg' : 'text-gray-300' }}">
            ...
            <a href="{{ route('director.profile.index') }}" 
               class="flex items-center px-4 py-3 rounded-lg sidebar-hover 
               {{ request()->routeIs('director.profile.index') ? 'text-gray-100 bg-gradient-to-br from-emerald-900 to-green-700 shadow-lg' : 'text-gray-300' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('director.students.index') }}" 
               class="flex items-center px-4 py-3 rounded-lg sidebar-hover 
               {{ request()->routeIs('director.students.index') ? 'text-gray-100 bg-gradient-to-br from-emerald-900 to-green-700 shadow-lg' : 'text-gray-300' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
