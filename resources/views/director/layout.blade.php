        ...
        <aside id="sidebar" class="fixed md:relative w-64 h-full bg-[#1a1a1a] text-white transform transition-transform duration-300 ease-in-out md:transform-none -translate-x-full md:translate-x-0 z-40">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ route('director.class.index') }}" 
                    class="flex items-center px-4 py-3 rounded-lg sidebar-hover 
                    {{ request()->routeIs('director.class.index') ? 'text-gray-100 bg-emerald-600 shadow-lg' : 'text-gray-300' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/>
                            <line x1="12" y1="12" x2="12" y2="6" stroke="currentColor" stroke-width="2"/>
                            <line x1="12" y1="12" x2="16" y2="12" stroke="currentColor" stroke-width="2"/>
                    ...
                    <a href="{{ route('director.teacher.index') }}" 
                    class="flex items-center px-4 py-3 rounded-lg sidebar-hover 
                    {{ request()->routeIs('director.teacher.index') ? 'text-gray-100 bg-emerald-600 shadow-lg' : 'text-gray-300' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                        </svg>
                        <span class="ml-3 font-medium">Professores</span>
                    </a>

                    <a href="{{ route('director.room.index') }}" 
                    class="flex items-center px-4 py-3 rounded-lg sidebar-hover 
                    {{ request()->routeIs('director.room.index') ? 'text-gray-100 bg-emerald-600 shadow-lg' : 'text-gray-300' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                        </svg>
                        <span class="ml-3 font-medium">Salas de aula</span>
                    </a>
